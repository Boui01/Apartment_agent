            ...
            const formData = {
                ...
                guarantor_address : 
                    ...
                    :
                        ...
                        event.target.Guarantor_Street_Number.value+' '+ 'road. '+event.target.Guarantor_Street.value+' '+
                    ...
                    <Form.Group  className='row'>
                        <Form.Group  className='col-6'>
                            ...
                            :
                                <>
                                    <Form.Label>{setLanguage === 'TH' ? 'ที่อยู่ (ุถ้ากรณีไม่มีเว้นช่องกรอกข้อมูลให้ว่าง)' : 'Address ( Please empty input if not have )'}</Form.Label>
                                    <Form.Group  className='row'>
                                        <Form.Control  className="form-control marginInput col" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" type="text" name="House_number" maxLength="10"  placeholder={setLanguage === 'TH' ? 'บ้านเลขที่' : "House Number"} pattern="^[a-zA-Z]+$" required/>
                                    ...
                                    <Form.Group  className='row'>
                                        ...
                                        <div className="col-6">
                                        <Form.Control placeholder={setLanguage === 'TH' ? 'รหัสไปรษณีย์' : "Zip Code"} name='Zip_code'  className="form-control mb-3" pattern="^[a-zA-Z]+$" />
                                        </div>
                                    </Form.Group>
                                </>
                            }
                        ...
                        <Form.Group  className='col-sm-5 marginGroup'>
                            ...
                            :
                                <>
                                    <Form.Group  className='row'>
                                        <Form.Control  className="form-control marginInput col" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" type="text" name="Guarantor_House_Number" maxLength="10"  placeholder={setLanguage === 'TH' ? 'บ้านเลขที่' : "House Number"} required/>
                                    ...
                                    <Form.Group  className='row'>
                                        ...
                                        <div className="col-6">
                                        <Form.Control placeholder={setLanguage === 'TH' ? 'รหัสไปรษณีย์' : "Zip Code"} name='Guarantor_Zip_code'  className="form-control mb-3" pattern="^[0-9]+$" />
                                        </div>
                                    </Form.Group>
                                </>
                            }
